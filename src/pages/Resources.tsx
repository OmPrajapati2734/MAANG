...
import { Search, Filter, FileText, Video, Book, GraduationCap } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <p className="text-gray-600">Curated materials to help you succeed in your interviews</p>
        </motion.div>
